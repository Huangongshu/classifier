...
#    pd.DataFrame(y_pred).to_excel(save_path+'/'+'y_pred'+str(i)+'.xlsx')
    ...
    pd.DataFrame(data={'Accuracy':[Accuracy],\
                       ...
                       'f1_v':[f1_v]})\
                       .to_excel(save_path+'/'+'test_y_pred'+str(i)+'.xlsx')
...
#path='/home/longpeiji/keras_dr/save_model'
#save_path='/home/longpeiji/keras_dr/validation'
...
save_path='/home/longpeiji/keras_user_resnet/test'
type1_path='/home/longpeiji/image_assessment/test/blur'
type2_path='/home/longpeiji/image_assessment/test/no_blur'
im_num=4750
